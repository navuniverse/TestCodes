...
public class SecurityUtils {
	...
	public static String generateHash(String input, String salt, Integer iterations) {
		...
		try {
			...
			System.err.println("Could not generate hashed password due to: " + e);
		}
		return passwordHash;
	}
	...
	public static boolean validatePassword(String originalPassword, String storedPassword, String storedSalt, Integer storedIterations) {
		...
		try {
			...
			for (int i = 0; i < hash.length && i < testHash.length; i++) {
				...
				| InvalidKeySpecException e) {
			System.err.println("Error in validating hashed password due to: " + e);
		}
		return diff == 0;
	...
	public static String getSalt() {
		try {
			...
			System.err.println("Error while generating salt for hashing due to: " + e);
		}
